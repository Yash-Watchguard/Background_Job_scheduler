...
class JobService:
    ...
    def update_job_execution(self, job_id:str,execution_id:str, status:ExecutionStatus, log_url:str|None=None, retry_count:int|None=None, finished_at:str|None=None):
        return self.job_repo.update_job_execution(job_id, execution_id, status, retry_count, finished_at, log_url)
